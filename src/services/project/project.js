...
export async function queryProInfoList(params) {
  console.log('请求项目信息卡列表',`${apiDev}/info_list/list/v1.1`)
...
export async function queryProInfoDetail(params) {
  console.log('请求角色详情',`${apiDev}/detail_info/v1.1`)
...
export async function addProInfo(params,token) {
  console.log('请求新增角色',`${apiDev}/add_info/v1.1`)
...
export async function updateProInfo(params,token) {
  console.log('请求更新角色',`${apiDev}/update_info/v1.1`)
